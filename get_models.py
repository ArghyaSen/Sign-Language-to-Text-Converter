...
def download_models():
    ...
    print("Downloading model files from GitHub... (This might take a minute)")
    try:
        urllib.request.urlretrieve(url, zip_name)
    except Exception as e:
        print("Master branch not responding, trying 'main' branch...")
    ...
    if found_count == 8:
        ...
        print("You can now run 'app.py' now")
    else:
        print(f"\nUh oh. Found {found_count} out of 8 files.")
